...
const C = {
  primary: '#FF0000',
  primaryGradient: 'linear-gradient(45deg, #FF0000, #CC0000, #990000)',
  bg: '#000000',
  surface: '#000000',
  surfaceAlt: '#121212',
  card: '#1A1A1A',
        ...
        <div style={{ width: '100%', maxWidth: (activeView === 'home') ? '1260px' : (activeView === 'store' || activeView === 'mim' || activeView === 'admin') ? '900px' : '600px', borderLeft: isMobile || activeView === 'home' ? 'none' : `1px solid ${C.border}`, borderRight: isMobile || activeView === 'home' ? 'none' : `1px solid ${C.border}`, background: C.bg, overflowX: 'hidden' }}>
                ...
                <>
                  ...
                  <div style={{ padding: '40px 16px' }}>
                    <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                      ...
                      <p style={{ fontSize: '14px', color: C.textSecondary }}>Choose your YouTube-side workflow</p>
                    </div>
                    <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                      {([
                        { role: 'creator' as const, title: 'Login as Channel', desc: 'Find ad-read and sponsorship briefs matched to your ValueSkins', icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2' },
                        { role: 'brand' as const, title: 'Login as Advertiser', desc: 'Find long-form channels with proven depth and retention', icon: 'M22 12h-4l-3 9L9 3l-3 9H2' },
                  ...
                  <div style={{ padding: '0 16px 16px' }}>
                    ...
                    {campaigns.length === 0 ? (
                      <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:'12px', padding:'22px 18px', marginBottom:'16px', textAlign:'center' }}>
                        <div style={{ fontSize:'16px', fontWeight:700, color:C.text, marginBottom:'6px' }}>Create a campaign first</div>
                        <div style={{ fontSize:'12px', color:C.textSecondary, lineHeight:1.5, marginBottom:'14px' }}>
                          Channel suggestions unlock after you publish your first campaign brief. Once the niche and requirements are set, matched creators will appear here.
                        </div>
                        <button onClick={() => setMarketplaceTab('campaigns')} style={{ background:C.primary, border:'none', borderRadius:'8px', padding:'10px 14px', color:'#fff', fontWeight:700, fontSize:'12px', cursor:'pointer' }}>
                          Go to Campaigns
                        </button>
          ...
          {activeView === 'store' && (
            <>
              {/* Store header */}
              <div style={{ padding: '12px 16px 0', position: 'sticky', top: 0, background: C.bg, zIndex: 10 }}>
                <span style={{ fontSize: '22px', fontWeight: 700, color: C.text, display: 'block', marginBottom: '14px' }}>ValueSkins Library</span>
                {/* Search bar */}
                <div style={{ position: 'relative', marginBottom: '14px' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={C.textMuted} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)' }}>
                    <circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>
